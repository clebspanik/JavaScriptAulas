...
document.form_main.start.onclick = () => stop();
...
function timer(){
    ...
    document.getElementById ("hrs").innerText = returnData("mn");
    document.getElementById ("hrs").innerText = returnData("sg");
    document.getElementById ("hrs").innerText = returnData("ml");
}
